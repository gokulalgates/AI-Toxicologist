...
try:
    ...
    print("Warning: sentence-transformers not installed. RAG will use simple text similarity.")
            ...
            for chemical_dir in results_dir.iterdir():
                ...
                if study_records_file.exists():
                    try:
                        ...
                        print(f"Warning: Could not load examples from {study_records_file}: {e}")
                        continue
